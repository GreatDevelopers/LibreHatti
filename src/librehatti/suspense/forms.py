...
class TaDaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'voucher_no'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'session'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'departure_time_from_tcc'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'arrival_time_at_site'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'departure_time_from_site'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'arrival_time_at_tcc'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'start_test_date'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'end_test_date'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'source_site'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'testing_site'].widget.attrs = {'class': 'form-control'}
        self.fields[
            'testing_staff'].widget.attrs = {'class': 'form-control'}
...
class StaffForm(forms.ModelForm):
    ...
    try:
        lab = forms.ModelChoiceField(queryset=Category.objects.filter(
            parent__isnull=True))
    except:
        pass
