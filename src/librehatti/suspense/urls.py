...
urlpatterns = [
                   ...
                   re_path(r'^tada_order_session/',views.tada_order_session, name= 'tada_order_session'),
                   ...
                   re_path(r'^quoted_add_distance', views.quoted_add_distance, name= 'quoted_add_distance'),
                   re_path(r'^quoted_save_distance', views.quoted_save_distance, name= 'quoted_save_distance'),
                   ...
                   re_path(r'^clearance_options/', views.clearance_options, name= 'clearance_options'),
                   ...
                   re_path(r'^car_taxi_advance_form/',views.car_taxi_advance_form, name= 'car_taxi_advance_form'),
                   re_path(r'^car_taxi_advance/',views.car_taxi_advance, name= 'car_taxi_advance')
              ]                    
