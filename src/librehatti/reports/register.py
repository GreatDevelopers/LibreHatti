        ...
        if form.is_valid() and date_form.is_valid():
            ...
            if mode_of_payment == "1":
                purchase_order = (
                    ...
                    .filter(mode_of_payment__method="Cash")
                    .values(
                        "date_time",
                    ...
                    .distinct()
                    .order_by("date_time", "voucherid__receipt_no_of_session")
                )
            else:
                purchase_order = (
                    PurchaseOrder.objects.filter(
                    ...
                    .exclude(mode_of_payment__method="Cash")
                    .values(
                        "date_time",
                        "bill__amount_received",
                        "voucherid__purchase_order_of_session",
            ...
            return render(
                request,
                "reports/daily_report_result.html",
                {
                    "result": result,
                    "sum": sum,
                    "mode_name": mode_name,
        ...
        if form.is_valid() and date_form.is_valid():
            ...
            for temp_value in voucher_object:
                ...
                if temp_value["purchase_order__buyer__first_name"]:
                    name = (
                        temp_value["purchase_order__buyer__first_name"]
                        + " "
                ...
                consultancy_var = CalculateDistribution.objects.values(
                    ...
                    voucher_no=temp_value["voucher_no"],
            ...
            return render(
                request,
                "reports/consultancy_funds_result.html",
                {
                    "result": result,
                    "back_link": back_link,
                    "start_date": start_date,
        ...
        if form.is_valid():
            ...
            for temp_value in bill_object:
                voucher_object = (
                    ...
                    .values("purchase_order_of_session")
                    .distinct()
                )
            ...
            return render(
                request,
                "reports/tds_report_result.html",
                {
                    "result": result,
                    "request": request_status,
        ...
        if form.is_valid():
            ...
            for temp_value in bill_object:
                ...
                material = (
                    ...
                    .filter(purchase_order__id=temp_value["purchase_order__id"])
                    .distinct()
                )
                ...
                temp_list.append(
                    temp_value["purchase_order__buyer__customer__user__email"]
                )
                temp_list.append(temp_value["totalplusdelivery"])
                taxesapplied = TaxesApplied.objects.values("tax").filter(
                    purchase_order=temp_value["purchase_order__id"]
            ...
            return render(
                request,
                "reports/payment_register_result.html",
                {
                    "result": result,
                    "request": request_status,
                    "servicetax": servicetax,
            ...
            return render(
                request,
                "reports/payment_register_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = DateRangeSelectionForm()
...
def suspense_clearance_register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            distribution = Distribution.objects.values(
                "college_income", "admin_charges"
            ).filter()[0]
            result = []
            temp = []
            for value in suspenseclearance:
                ...
                if not suspense:
                    continue
                suspense = SuspenseOrder.objects.values(
                    "voucher",
                    "session_id",
                    "purchase_order",
                    "purchase_order__date_time",
            ...
            return render(
                request,
                "reports/suspense_clearance_result.html",
                {
                    "result": result,
                    "request": request_status,
            ...
            return render(
                request,
                "reports/suspense_clearance_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = DateRangeSelectionForm()
...
Teacher = [
    "Prof. kulbir Sing Gill",
    "Dr. B.S. Walia",
    "Dr. B.S. Walia",
    "Prof. Harjinder Singh",
    "Prof. Gurdeepak Singh",
    "Dr. Harpal Singh",
    "Dr. Hardeep Singh",
    " Dr. Harvinder Singh",
    "Prof. Parshant Garg",
...
def servicetax_register_year(year):
    ...
    totalplustax = 0
    taxes_name = (
        TaxesApplied.objects.values("surcharge_name", "surcharge_value")
    ...
    if request.method == "POST":
        ...
        if form.is_valid() and data_form.is_valid():
            ...
            for value in purchase_order:
                ...
                voucherid = VoucherId.objects.values(
                    "purchase_order_of_session"
                ).filter(purchase_order=value["id"])[0]
                temp.append(voucherid["purchase_order_of_session"])
                temp.append(value["date_time"])
                if value["buyer__first_name"]:
                    address = (
                ...
                material = (
                    PurchasedItem.objects.values("item__category__name")
                    .filter(purchase_order__id=value["id"])
                    .distinct()
                )
                for item in material:
                    if flag == 1:
...
def main_register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            purchase_order = (
                PurchaseOrder.objects.filter(date_time__month=month)
                ...
                .exclude(voucherid__is_special=1)
                .distinct()
                .order_by("date_time", "voucherid__receipt_no_of_session")
            )
            distribution = Distribution.objects.values(
            ...
            return render(
                request,
                "reports/main_register_result.html",
                {
                    "request": request_status,
                    "distribution": distribution,
                    "result": result,
            ...
            return render(
                request,
                "reports/main_register_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = MonthYearForm()
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            quotedtaxesapplied = QuotedTaxesApplied.objects.values(
                "quoted_order__id"
            ).filter(quoted_order__date_time__range=(start_date, end_date))
            quotedorder = QuotedOrder.objects.values(
                "id",
                ...
                "buyer__email",
                "quotedbill__totalplusdelivery",
                "quotedbill__grand_total",
                "delivery_address",
            ).filter(id__in=quotedtaxesapplied)
            temp = []
            result = []
            material_list = ""
            flag = 1
            ...
            for order in quotedorder:
                ...
                quoteditem = (
                    QuotedItem.objects.values(
                        "item__category__name", "item__category__id"
                    )
                    .filter(quoted_order=order["id"])
                    .distinct()
                )
            ...
            return render(
                request,
                "reports/proforma_register.html",
                {
                    "result": result,
                    "request": request_status,
                    "surcharge_values": surcharge_values,
            ...
            return render(
                request,
                "reports/proforma_reg_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = DateRangeSelectionForm()
        ...
        if form.is_valid():
            ...
            for order in non_payment_order:
                ...
                if order["buyer__customer__address__pin"] == "None":
                    address = (
                        order["buyer__customer__address__street_address"]
                        + ", "
...
def client_register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(
                request,
                "reports/client_register_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = DateRangeSelectionForm()
    ...
    if request.method == "POST":
        ...
        if form.is_valid() and date_form.is_valid():
            ...
            for value in purchase_item:
                ...
                total_tax = TaxesApplied.objects.filter(
                    purchase_order=value["purchase_order_id"]
                ).aggregate(Sum("tax"))
        ...
        if form.is_valid():
            ...
            suspenseorder = (
                ...
                .values(
                    ...
                    "purchase_order__buyer__customer__address__pin",
                    "purchase_order__buyer__customer__address__province",
                    "purchase_order__bill__total_cost",
                    "purchase_order__date_time",
            ...
            for value in suspenseorder:
                ...
                if value["purchase_order__buyer__first_name"]:
                    name = (
                        value["purchase_order__buyer__first_name"]
                        + " "
            ...
            return render(
                request,
                "reports/suspense_register.html",
                {
                    "request": request_status,
                    "result": result,
                    "back_link": back_link,
...
def registered_users(request):
    ...
    if request.method == "POST":
        ...
        return render(
            request,
            "reports/registeredusers_form.html",
            {"form": form, "request": request_status},
        )
...
def lab_report(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid() and date_form.is_valid():
            ...
            purchase_item = PurchasedItem.objects.filter(
                purchase_order__date_time__range=(start_date, end_date),
                item__category__parent=category,
            ).values(
                "purchase_order_id",
                "purchase_order__date_time",
                "price",
...
def pending_clearance_register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(
                request,
                "reports/pending_clearance_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = DateRangeSelectionForm()
...
def tada_register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            start_date = request.POST["start_date"]
            end_date = request.POST["end_date"]
            suspense_cleared = SuspenseClearance.objects.values(
                "voucher_no", "session_id", "clear_date"
            ).filter(clear_date__range=(start_date, end_date))
            result = []
            ...
            return render(
                request,
                "reports/tada_register_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = DateRangeSelectionForm()
        ...
        if form.is_valid():
            ...
            for voucher in suspense_cleared:
                ...
                if tada_amount["tada_amount__sum"]:
                    grand_total = (
                        int(voucher["boring_charge_external"])
            ...
            return render(
                request,
                "reports/tada_othercharges_form.html",
                {"form": form, "request": request_status},
            )
    else:
        form = DateRangeSelectionForm()
...
def client_details_according_to_amount(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            bill = Bill.objects.values("purchase_order").filter(
                amount_received__gte=amount
            )
            voucherid = (
                VoucherId.objects.filter(purchase_order__in=bill)
                .values(
                    "receipt_no_of_session",
                    "receipt_date",
                    "purchase_order_of_session",
                ...
                .distinct()
                .order_by("session_id", "receipt_no_of_session")
            )
