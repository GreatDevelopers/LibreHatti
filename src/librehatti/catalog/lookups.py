...
class BuyerLookup(LookupChannel):
    ...
    def format_item_display(self, obj):
        result = User.objects.values('first_name','last_name',
            ...
            'customer__address__district','customer__company','customer__gst_in').filter(id = obj.id)[0]
        return "<b>Name or Title:</b> %s <br> <b>Company:</b> %s <br> <b>Address:</b> %s <br> %s <br> <b>GST In:</b> %s  \
