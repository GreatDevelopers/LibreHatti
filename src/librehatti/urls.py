...
urlpatterns = [
    ...
    re_path(r'^catalog/', include(('librehatti.catalog.urls','catalog'), namespace='catalog')),
    re_path(r'^useraccounts/', include(('useraccounts.urls','useraccounts'), namespace='useraccounts')),
    re_path(r'^print/', include(('librehatti.prints.urls','print'), namespace='print')),
    ...
    re_path(r'^list_saved_registers', reports_views.list_saved_registers, name='list_saved_registers'),
    re_path(r'daily_result', register.daily_report_result, name='daily_report_result'),
    re_path(r'consultancy_funds_report', register.consultancy_funds_report, name='consultancy_funds_report'),    
    ...
    re_path(r'suspense_clearance_register', register.suspense_clearance_register, name='suspense_clearance_register'),
    ...
    re_path(r'^proforma_register', register.proforma_register, name='proforma_register'),
    re_path(r'^non_payment_register', register.non_payment_register, name='non_payment_register'),
    ...
    re_path(r'^suspense_register', register.suspense_register, name='suspense_register'),
    re_path(r'^registered_users', register.registered_users, name='registered_users'),
    re_path(r'^filter_sub_category/', reports_views.filter_sub_category, name='filter_sub_category'),
    ...
    re_path(r'^tax/', prints_views.tax, name='tax'),
    re_path(r'^bills/', include(('librehatti.bills.urls','bills'), namespace='bills')),
    re_path(r'^suspense/', include(('librehatti.suspense.urls','suspense'), namespace='suspense')),
    ...
    re_path(r'^proforma_details/',previous_history.proforma_details, name='proforma_details'),
    re_path(r'^admin/doc/', include('django.contrib.admindocs.urls')),
    re_path(r'^admin/lookups/', include(ajax_select_urls)),
    re_path(r'^voucher/', include(('librehatti.voucher.urls','voucher'), namespace='voucher')),
