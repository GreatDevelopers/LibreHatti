...
urlpatterns = patterns('',
    ...
    url(r'^lob_report','librehatti.reports.register.lob_report'),
    url(r'^labs_register','librehatti.reports.register.labs_register'),
    url(r'^andlab_report', 'librehatti.reports.register.andlab_report'),
