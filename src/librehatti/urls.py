...
urlpatterns = patterns('',
    ...
    url(r'daily_report', 'librehatti.reports.views.daily_report_form', name='daily_report'),
    url(r'daily_result', 'librehatti.reports.views.daily_report_result', name='daily_report_result'),
