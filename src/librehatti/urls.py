...
from .reports import previous_history, register, views as reports_views
...
urlpatterns = [
    ...
    re_path(
        r"^useraccounts/",
        include(
            ("useraccounts.urls", "useraccounts"), namespace="useraccounts"
        ),
    ),
    re_path(
        r"^print/",
        include(("librehatti.prints.urls", "print"), namespace="print"),
    ),
    ...
    re_path(
        r"daily_result",
        register.daily_report_result,
        name="daily_report_result",
    ),
    re_path(
    ...
    re_path(
        r"tds_report", register.tds_report_result, name="tds_report_result"
    ),
    re_path(
        r"payment_report", register.payment_register, name="payment_register"
    ),
    re_path(
    ...
    re_path(
        r"servicetax", register.servicetax_register, name="servicetax_register"
    ),
    re_path(r"^main_register", register.main_register, name="main_register"),
    re_path(
        r"^proforma_register",
        register.proforma_register,
        name="proforma_register",
    ),
    re_path(
    ...
    re_path(
        r"^client_register", register.client_register, name="client_register"
    ),
    re_path(
        r"^material_report", register.material_report, name="material_report"
    ),
    re_path(r"^lab_report", register.lab_report, name="lab_report"),
    re_path(
        r"^suspense_register",
        register.suspense_register,
        name="suspense_register",
    ),
    re_path(
        r"^registered_users", register.registered_users, name="registered_users"
    ),
    re_path(
    ...
    re_path(
        r"^suspense_bill/", prints_views.suspense_bill, name="suspense_bill"
    ),
    re_path(r"^quoted_bill/", prints_views.quoted_bill, name="quoted_bill"),
    re_path(
        r"^bills/",
        include(("librehatti.bills.urls", "bills"), namespace="bills"),
    ),
    re_path(
        r"^suspense/",
    ...
    re_path(
        r"^generate_register/", GenerateRegister.as_view(), name="view_register"
    ),
    ...
    re_path(
        r"^tinymce/", include(("tinymce.urls", "tinymce"), namespace="tinymce")
    ),
    re_path(
        r"^programmeletter/",
