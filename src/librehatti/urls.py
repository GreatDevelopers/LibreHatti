...
urlpatterns = [
    ...
    url(r'^catalog/', include(('librehatti.catalog.urls','catalog'), namespace='catalog')),
    url(r'^useraccounts/', include(('useraccounts.urls','useraccounts'), namespace='useraccounts')),
    url(r'^print/', include(('librehatti.prints.urls','print'), namespace='print')),
    ...
    url(r'^bills/', include(('librehatti.bills.urls','bills'), namespace='bills')),
    url(r'^suspense/', include(('librehatti.suspense.urls','suspense'), namespace='suspense')),
    ...
    url(r'^voucher/', include(('librehatti.voucher.urls','voucher'), namespace='voucher')),
